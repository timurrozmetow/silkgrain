...
export const ACTION_PHRASE: Record<AuditAction, string> = {
  ...
  'recipe.published_changed': 'changed whether the shop shows recipe',
  'recipe.image_updated': 'changed the image on recipe',
  'faq.created': 'added the FAQ entry',
  'faq.updated': 'edited the FAQ entry',
  'faq.published_changed': 'changed whether the Help page shows',
