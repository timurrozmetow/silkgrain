 ...
 */
/**
 * The route's typed hooks without importing the route object.
 *
 * `productRoute.useParams()` would be the same thing and would also make this module import the
 * one that lazily imports it - a cycle that only shows up as a blank page when the chunk order
 * happens to change. `getRouteApi` looks the route up by id at render time instead.
 */
