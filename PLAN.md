...
**Acceptance:** каждый экран сверен с макетом по цветам/отступам/типографике; Lighthouse (десктоп) ≥ 90 Performance, ≥ 95 A11y и SEO; клавиатурная навигация и фокус-ловушки работают.

> Адаптив исключён из Фазы 5 по решению D-8 — задача 5.11 (10 ч) снята, оценка фазы падает до **60–80 ч**. Работа вынесена в `BACKLOG.md`.
